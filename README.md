...
<img src="https://github.com/SergeevKst/bubble/blob/master/assets/healthCheck.PNG?raw=true" width="900" prop>

# 2.2. If you want to sign up you will use the next URL
<img src="https://github.com/SergeevKst/bubble/blob/master/assets/register.PNG?raw=true" width="900" add prop>

# 2.3. If you want to authenticate yourself you will use the next URL
<img src="https://github.com/SergeevKst/bubble/blob/master/assets/auth.PNG?raw=true" width="900" success deploy>

# 2.4.  If you want to observe your own role you should grab your personal token and check your role with the next URL
<img src="https://github.com/SergeevKst/bubble/blob/master/assets/roles.PNG?raw=true" width="900" result>

# 2.5. If you want to send requests as an authorized user using swagger
<img src="https://github.com/SergeevKst/bubble/blob/master/assets/swaggerHomePage.PNG?raw=true" width="900" result>
